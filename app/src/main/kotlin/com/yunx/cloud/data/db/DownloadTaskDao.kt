...
interface DownloadTaskDao {
    ...
    @Query("UPDATE download_task SET status = :status, savePath = :savePath, avgSpeed = :avgSpeed, completedAt = :completedAt WHERE id = :id")
    suspend fun complete(id: Long, status: Int, savePath: String, avgSpeed: Long = 0L, completedAt: Long = 0L)
