...
fun BoxScope.CustomFabMenu(
    ...
    Column(
        ...
        AnimatedVisibility(
            visible = expanded,
            enter = fadeIn(NativeSpringSoft) + slideInVertically(NativeSpringIntOffset) { it / 2 },
            exit = fadeOut(NativeSpringSoft) + slideOutVertically(NativeSpringIntOffset) { it / 2 }
        ) {
            Column(
                horizontalAlignment = Alignment.End,
